...
----
$ git clone git@github.com:cavitatacan55/myswarmproject
...
== More Information
You can learn more about this booster and the WildFly Swarm runtime in the link:http://appdev.openshift.io/docs/wf-swarm-runtime.html[WildFly Swarm Runtime Guide].
